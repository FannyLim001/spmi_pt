...
<div class="card">
    <div class="card-header pb-0 px-3">
        <div class="row">
            <div class="col-7">
                <h5 class="text-black text-capitalize ps-3">Pertanyaan</h5>
            </div>
            <div class="col-4">
                <a href="/pertanyaan/tambah">
            ...
            @foreach ($pertanyaan as $p )
                <tr>
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                                <p class="text-sm text-secondary mb-0">{{ Str::limit($p->pertanyaan, 90) }}</p>
                            </div>
                        </div>
                    </td>
                    <td>
                        <p class="text-xs font-weight-bold mb-0">{{ $p->kategori_pertanyaan }}</p>
                    </td>
                    <td class="align-middle">
                        <a href="/pertanyaan/edit/{{$p->id}}">
