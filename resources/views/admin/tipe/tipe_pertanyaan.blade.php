...
<div class="card">
    <div class="card-header pb-0 px-3">
        <div class="row">
            <div class="col-5">
                <h5 class="text-black text-capitalize ps-3">Tipe Pertanyaan</h5>
            </div>
            <div class="col-3">
                <a href="/pertanyaan/tipe/tambah">
        ...
        <table id="table_id" class="table align-items-center mb-0">
            <thead>
                <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tipe Pertanyaan</th>
