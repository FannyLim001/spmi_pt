                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group input-group-static mb-4">
                                ...
                                <input type="number" class="form-control" name="total_mhs" value="{{ $p->total_mhs }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group input-group-static mb-4">
                                ...
                                <input type="number" class="form-control" name="total_dosen" value="{{ $p->total_dosen }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group input-group-static mb-4">
                                ...
                                <input type="number" class="form-control" name="total_publikasi" value="{{ $p->total_publikasi }}">
                            </div>
                        </div>
                    </div>
